            ...
            return (
              <Link
                ...
                className={`
                  ...
                  ${isActive
                    ? 'bg-gradient-to-r from-blue-600/10 to-indigo-600/10 text-blue-700 dark:text-blue-400'
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="sticky top-0 z-30 bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl border-b border-gray-200 dark:border-gray-800 h-16 flex items-center px-4 lg:px-6 gap-3">
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <span className="text-xs font-semibold text-gray-500 dark:text-gray-400 hidden sm:block">₦ Naira</span>
          </div>
        </header>

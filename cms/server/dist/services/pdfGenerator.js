...
exports.generateQuotationPDFBuffer = generateQuotationPDFBuffer;
 ...
 */
async function generateQuotationPDFBuffer(quotation, customer, settings) {
    var _a, _b;
    const companyName = (settings === null || settings === void 0 ? void 0 : settings.companyName) || 'PLASMA WATER AFRICA';
    const companySlogan = (settings === null || settings === void 0 ? void 0 : settings.slogan) || 'Quality Water Solutions';
    const companyAddress = (settings === null || settings === void 0 ? void 0 : settings.address) || 'P.O BOX 4996-00200, NAIROBI, KENYA';
    const companyPhone = (settings === null || settings === void 0 ? void 0 : settings.phone) || '0710743793';
    const companyEmail = (settings === null || settings === void 0 ? void 0 : settings.email) || 'plasmawaterafrica@gmail.com';
    const logoUrl = ((_a = settings === null || settings === void 0 ? void 0 : settings.logo) === null || _a === void 0 ? void 0 : _a.url) || '/logo1.png';
      ...
      <div class="pdf-container">
        ...
        <div class="totals-wrapper">
          <div class="totals-box">
            ...
            ${((_b = quotation.shippingInfo) === null || _b === void 0 ? void 0 : _b.cost) ? `<div class="total-row"><span>Shipping</span><span>KES ${quotation.shippingInfo.cost.toLocaleString()}</span></div>` : ''}

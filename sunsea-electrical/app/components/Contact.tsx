    ...
    <section id="contact" className="section-padding bg-[#f8f9fa] dark:bg-[#0d1220]">
      <div className="container-custom">
        <Reveal className="text-center max-w-2xl mx-auto mb-12">
          ...
          <p className="text-[var(--color-muted)] mt-3">Reach out to us for your electrical engineering needs</p>
        </Reveal>
          ...
          <Reveal direction="left" delay={0.1}>
            <div className="space-y-4">
              {contactItems.map((item) => (
                <div key={item.title} className="card p-6 hover-lift border border-gray-100 dark:border-gray-800">
              ...
              <div className="card overflow-hidden p-0 border border-gray-100 dark:border-gray-800">
                <iframe

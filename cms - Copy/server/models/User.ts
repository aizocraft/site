...
export interface IUser extends Document {
  ...
  role: 'user' | 'sales' | 'admin' | 'engineer';
  ...
  // Construction link: engineer profile this user governs
  engineerProfile?: mongoose.Types.ObjectId;
...
role: { 
    type: String, 
    enum: ['user', 'sales', 'admin', 'engineer'], 
    default: 'user' 
  },
  engineerProfile: { type: mongoose.Types.ObjectId, ref: 'Engineer' },
  phone: { 
    type: String, 
    trim: true,

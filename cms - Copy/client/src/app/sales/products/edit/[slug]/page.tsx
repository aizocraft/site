// src/app/sales/products/edit/[slug]/page.tsx
'use client'
...
import { getProduct, updateProduct, uploadProductImages, deleteProductImage, getImageUrl, getSuppliers } from '@/lib/api';
...
// ==================== MAIN COMPONENT ====================
export default function SalesEditProductPage() {
  ...
  useEffect(() => {
    if (product) {
      // ✅ Fix: Handle supplier properly - it could be a string (ID) or a populated object
      let supplierId = '';
      let supplierName = '';
      ...
      // If supplierName is provided directly, use it
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-900 focus:ring-2 focus:ring-blue-500"
                      placeholder={selectedSupplier ? selectedSupplier.name : "Search for a supplier..."}
                    />
                  </div>

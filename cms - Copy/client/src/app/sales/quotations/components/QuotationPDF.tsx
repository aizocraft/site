...
<div class="company-name">AIZO TECH SOLUTIONS</div>
        <div class="company-address">Kenya</div>
               <div class="company-tel">TEL: 0741653862</div>
        <div class="company-email">Email: isaacngatho.dev@gmail.com</div>
      </div>
      <div class="logo-area">
    ...
    <div class="footer-main">
      <div class="footer-services">
        <div class="services-list">
          <span class="service-item">CCTV Installation</span>
          <span class="service-item">Website Development</span>
          <span class="service-item">App Development</span>
          <span class="service-item">ERP & IOT Support</span>
...
<img src="${footerLogoUrl}" class="footer-logo" alt="Aizo Tech Solutions" crossorigin="anonymous" onerror="this.style.display='none'" />
      </div>

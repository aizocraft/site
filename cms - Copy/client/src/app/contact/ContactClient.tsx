...
<div className="absolute top-0 right-0 w-96 h-96 bg-[#7c9870]/10 rounded-full blur-3xl" />
<div className="absolute bottom-0 left-0 w-96 h-96 bg-[#606062]/10 rounded-full blur-3xl" />
        </div>
...
<div className="absolute top-0 right-0 w-32 h-32 bg-[#7c9870]/10 rounded-bl-full" />

                <div className="p-6 md:p-8">
                  <div className="flex items-start gap-4 mb-6">
<div className="w-14 h-14 rounded-xl bg-[#7c9870] flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                  ...
                  <motion.a
                    ...
                    className="inline-flex items-center gap-2 text-sm text-[#7c9870] dark:text-[#9aae8d] hover:text-[#6a8360] dark:hover:text-[#8a9d7d] font-medium mt-2 group/link"
                    whileHover={{ x: 4 }}
                  >
                    <Navigation size={14} />
                    Get Directions
...
<div className="w-12 h-12 rounded-xl bg-emerald-600 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 shadow-md">
                ...
                {/* Email Card */}
                <div className="group bg-white dark:bg-gray-900 rounded-2xl p-6 border border-gray-200 dark:border-gray-800 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
<div className="w-12 h-12 rounded-xl bg-[#7c9870] flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 shadow-md">
...
<motion.a
                    ...
                    className="text-gray-600 dark:text-gray-400 hover:text-[#7c9870] dark:hover:text-[#9aae8d] transition-colors break-all group/link inline-flex items-center gap-1"
                    whileHover={{ x: 4 }}
                  >
                    <Mail size={12} />
                        ...
                        <input
                          ...
                          className={`w-full pl-10 pr-4 py-3 border rounded-xl transition-all duration-200 bg-white dark:bg-gray-800 dark:text-white ${
                            errors.name
                              ...
                              : focusedField === 'name'
                              ? 'border-[#7c9870] ring-2 ring-[#7c9870]/20'
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <select
                          ...
                          className="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-700 rounded-xl bg-white dark:bg-gray-800 dark:text-white focus:ring-2 focus:ring-[#7c9870] focus:border-transparent transition-all duration-200 appearance-none cursor-pointer"
                        >
...
: 'bg-[#7c9870] hover:bg-[#6a8360] text-white shadow-lg hover:shadow-xl'
                      }`}

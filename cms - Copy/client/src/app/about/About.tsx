...
<div className="bg-white dark:bg-gray-900 rounded-2xl p-5 sm:p-6 border border-gray-300 dark:border-gray-700 shadow-xl">
      <div className="text-center mb-5">
<div className="w-14 h-14 rounded-2xl bg-gray-600 flex items-center justify-center mx-auto mb-3 shadow-lg">
...
className="flex-1 bg-gray-600 hover:bg-gray-700 text-white py-3 rounded-xl font-semibold text-sm shadow-md hover:shadow-lg flex items-center justify-center gap-2 disabled:opacity-60 transition-all duration-200"
        ...
        <motion.button
          ...
          className="px-5 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-900/30 py-3 rounded-xl font-semibold text-sm flex items-center justify-center gap-2 transition-all duration-200"
          whileHover={{ scale: 1.02, y: -1 }}
          whileTap={{ scale: 0.98 }}
        >
...
<h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white leading-tight mb-6">
              ...
              <div className="space-y-5 mb-10">
                {whyUs.map((item, i) => (
                  ...
                  >
                    ...
                    >
                      <CheckCircle2 size={22} className="text-[#7c9870] mt-0.5 shrink-0" />
                    </motion.div>
              ...
              <div className="flex flex-wrap gap-4">
                <motion.a
                  href="/contact"
                  className="px-7 py-3.5 bg-gray-600 hover:bg-gray-700 text-white font-semibold rounded-xl text-base transition-all duration-200 shadow-md hover:shadow-lg"
                ...
                <motion.a
                  href="/products"
                  className="px-7 py-3.5 bg-transparent border-2 border-gray-300 dark:border-gray-700 hover:border-[#7c9870] dark:hover:border-[#7c9870] text-gray-700 dark:text-gray-300 hover:text-[#7c9870] dark:hover:text-[#9aae8d] font-semibold rounded-xl text-base transition-all duration-200"
                  whileHover={{ scale: 1.02, y: -2 }}
                  whileTap={{ scale: 0.98 }}
                >
                  Browse Products
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-6">
                {[
                  ...
                  <motion.div
                    key={i}
                    className="group bg-gray-50 dark:bg-gray-900 rounded-xl p-6 text-center border border-gray-200 dark:border-gray-800 hover:border-[#7c9870] dark:hover:border-[#7c9870] transition-all duration-300 hover:shadow-lg"
                    whileHover={{ y: -4 }}
                    transition={{ type: "spring", stiffness: 300 }}
                  >
                    <div className="w-14 h-14 rounded-xl bg-gray-100 dark:bg-gray-900/30 flex items-center justify-center mx-auto mb-4 group-hover:bg-[#7c9870] transition-all duration-300">
                      <item.icon size={24} className="text-[#7c9870] dark:text-[#9aae8d] group-hover:text-white transition-colors duration-300" />
                    </div>
                    <p className="text-base font-semibold text-gray-900 dark:text-white group-hover:text-[#7c9870] dark:group-hover:text-[#9aae8d] transition-colors">
                      {item.label}
                    </p>
                  </motion.div>
                ))}
        ...
        <div className="w-full px-4 sm:px-6 lg:px-32">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white">
              What Our{' '}
              <span className="text-[#7c9870] dark:text-[#9aae8d]">Clients Say</span>
            </h2>
            <div className="w-20 h-0.5 bg-[#7c9870] mx-auto mt-4 rounded-full" />
          </motion.div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {testimonials.map((t, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Quote size={28} className="text-[#7c9870] dark:text-[#606062] mb-4" />
      ...
      <AnimatePresence>
        {modalOpen && (
          ...
          >
            ...
            >
<div className="bg-gray-700 p-4 flex items-center justify-between rounded-t-2xl">
